...
CREATE USER root WITH PASSWORD 'IAMTHEONE@!' -s;
...
COMMENT ON COLUMN public.agencias.fklogradouro IS 'FK para a tabela logradouros da cidade onde se localiza a agência bancária.';
...
COMMENT ON COLUMN public.agenciastels.fkagencia IS 'FK (composta) para a tabela agencias.';
COMMENT ON COLUMN public.agenciastels.fktipotelefone IS 'FK para a tabela telefonestipos';
...
COMMENT ON COLUMN public.areasdeestudocursos.fkareadeestudo IS 'Parte da CC (com fkcurso), FK para a tabela Áreas de Estudos (areadeestudos).';
...
COMMENT ON COLUMN public.areasdeestudodisciplinas.fkareadeestudo IS 'Parte da CC (com fkdisciplina), FK para a tabela Áreas de Estudos (areadeestudos).';
...
COMMENT ON COLUMN public.areasdeestudolivros.fkareadeestudo IS 'Parte da CC (com fklivro), FK para tabela Áreas de Estudos (areadeestudos).';
...
CREATE TABLE public.armazens (
    ...
    fklogradouro integer DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.armazens.fklogradouro IS 'FK indicando o logradouro onde se localiza o armazém.';
...
COMMENT ON COLUMN public.armazens.fkcliente IS 'FK indicando o cliente que é dono ou aluga o armazém.';
...
COMMENT ON COLUMN public.atribuicoes.fkdisciplina IS 'Parte da CC Composta com fkprofessor, FK indicando o código da disciplina.';
...
COMMENT ON COLUMN public.atuacoes.fkfuncionario IS 'Parte da CC Composta com fktarefaprojeto e dtinicio, FK para tabela funcionários.';
COMMENT ON COLUMN public.atuacoes.dtinicio IS 'Parte da CC Composta com fkfuncionario e fktarefaprojeto, é a Data de início de atuação do Funcionário em uma tarefa de um projeto.';
...
COMMENT ON COLUMN public.autores.fklogradouro IS 'FK para a tabela logradouros da cidade residência do autor.';
...
COMMENT ON COLUMN public.autorestels.fktipotelefone IS 'FK para a tabela telefonestipos.';
...
COMMENT ON COLUMN public.autorias.fkautor IS 'Parte de uma CC composta com fklivro, FK apontando para a tabela Autores';
...
COMMENT ON COLUMN public.bairros.fkcidade IS 'FK para a tabela cidades onde se localiza o bairro.';
...
COMMENT ON COLUMN public.bairroslogradouros.fkbairro IS 'FK para a tabela bairros';
COMMENT ON COLUMN public.bairroslogradouros.fklogradouro IS 'FK para a tabela logradouros';
...
COMMENT ON COLUMN public.bancos.fklogradourosede IS 'FK para a tabela logradouros com o código do logradouro da sede do banco.';
...
COMMENT ON COLUMN public.bibliografia.fklivro IS 'Parte da CC (composta com fkdisciplina) e FK para tabela livros.';
...
COMMENT ON COLUMN public.capacitacoes.fkfuncionario IS 'Parte da UK (composta com fkcurso) e FK para a tabela funcionário.';
...
CREATE TABLE public.veiculos (
    ...
    ukplaca character(7),
    fktipoveiculo smallint NOT NULL,
    fkmodelo smallint DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.veiculos.fktipoveiculo IS 'FK para a tabela veiculotipos (Tipos de Veículos).';
COMMENT ON COLUMN public.veiculos.fkmodelo IS 'FK para a tabela veiculosmodelo (Modelos de Veículos).';
COMMENT ON COLUMN public.veiculos.fkfuncionario IS 'FK para a tabela funcionarios (funcionário proprietário do carro).';
...
COMMENT ON COLUMN public.cidades.fkestadodopais IS 'FK para tabela estadosdopais (estados, comarcas ou condados de uma união federativa de estados).';
...
COMMENT ON COLUMN public.clientes.fklogradouro IS 'FK com o código do logradouro comercial do cliente';
...
COMMENT ON COLUMN public.clientestels.fktipotelefone IS 'FK para a tabela tipos_telefones';
...
CREATE TABLE public.consultas (
    ...
    fkplanodesaude integer NOT NULL,
...
COMMENT ON COLUMN public.consultas.fkmedico IS 'FK para a tabela medicos.';
...
COMMENT ON COLUMN public.consultas.fkplanodesaude IS 'FK para a tabela planosdesaude';
...
CREATE TABLE public.contas (
    ...
    fkagencia character(6) NOT NULL,
    pknuconta character(6) NOT NULL,
    fkfuncionario integer,
    dtcadconta date,
...
COMMENT ON COLUMN public.contas.pknuconta IS 'Sequencia que identifica a conta (na agencia do banco). Junto com fkbanco e fkagencia forma a PK Composta.';
COMMENT ON COLUMN public.contas.fkfuncionario IS 'FK apontando para o Funcionario que é o titular da conta.';
...
COMMENT ON COLUMN public.cursos.fkinstituicao IS 'FK apontando para a tabela Instituições de Ensino.';
...
CREATE TABLE public.departamentos (
    ...
    fkfuncionariogerente integer DEFAULT NULL::numeric,
    fkdeptosuperior character(3) DEFAULT NULL::bpchar,
...
COMMENT ON COLUMN public.departamentos.fkfuncionariogerente IS 'FK para a tabela funcionarios (gerente do departamento).';
COMMENT ON COLUMN public.departamentos.fkdeptosuperior IS 'FK para a tabela departamentos. Código do departamento superior na empresa.';
...
CREATE TABLE public.departamentostels (
    ...
    fktelefonetipo smallint DEFAULT NULL::numeric,
    nutelefone character(15) NOT NULL,
    txnomecontato character varying(30),
    dtcaddeptotel date
);
...
COMMENT ON COLUMN public.departamentostels.fktelefonetipo IS 'FK apontando para a tabela Tipos de Telefones.';
...
COMMENT ON COLUMN public.editoras.fklogradouro IS 'FK apontando para a tabela Logradouros.';
...
COMMENT ON COLUMN public.editorastels.fktipotelefone IS 'FK apontando para a tabela tipos_telefones.';
...
CREATE TABLE public.empresas (
    ...
    txcomplemento character varying(25) DEFAULT NULL::character varying,
    nucep character(8) DEFAULT NULL::bpchar,
    fksetoratuacao integer DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.empresas.fklogradouro IS 'FK apontando para o logradouro da empresa';
...
COMMENT ON COLUMN public.empresas.fksetoratuacao IS 'FK apontando  o setor de atuação da empresa.';
...
COMMENT ON COLUMN public.empresastels.fktipotelefone IS 'FK apontando para a tabela Tipos de Telefones';
...
COMMENT ON COLUMN public.fabricantes.fklogradouro IS 'FK para a tabela logradouros (logradouro do fabricante).';
...
COMMENT ON COLUMN public.fabricantes.fksetoratuacao IS 'FK apontando  o setor de atuação da fabricante.';
...
COMMENT ON COLUMN public.fabricantestels.fktipotelefone IS 'FK para a tabela telefonestipos';
...
COMMENT ON COLUMN public.feitospor.fkservico IS 'FK para tabela serviços (prestados por uma oficina).';
...
COMMENT ON COLUMN public.fornecedores.fklogradouro IS 'FK apontando  o logradouro do Fornecedor.';
...
COMMENT ON COLUMN public.fornecedores.fksetoratuacao IS 'FK para a tabela setoresdeatuacao (setor de atuação do fornecedor).';
...
COMMENT ON COLUMN public.fornecedorestels.fktipotelefone IS 'FK apontando para a tabela tipos_telefones';
...
CREATE TABLE public.funcionarios (
    ...
    fkdepto character(3) DEFAULT NULL::bpchar,
    fkfuncao integer DEFAULT NULL::numeric,
    fkniveleducacao integer DEFAULT NULL::numeric,
    fklogradouro integer DEFAULT NULL::numeric,
    txcomplemento character varying(25) DEFAULT NULL::character varying,
...
COMMENT ON COLUMN public.funcionarios.fkdepto IS 'FK apontando para a tabelas Departamentos.';
COMMENT ON COLUMN public.funcionarios.fkfuncao IS 'FK apontando para a tabela Funções.';
COMMENT ON COLUMN public.funcionarios.fkniveleducacao IS 'FK com o código do nível de educação (escolaridade)';
COMMENT ON COLUMN public.funcionarios.fklogradouro IS 'FK com o código do Logradouro de moradia do Funcionário.';
...
COMMENT ON COLUMN public.funcionariosplanos.fkplanodesaude IS 'FK apontando para a tabela ';
...
COMMENT ON COLUMN public.funcionariostels.fktipotelefone IS 'FK apontando para a tabela tipos de telefones.';
...
COMMENT ON COLUMN public.habilitacoes.fkprofessor IS 'Parte da PK e FK indicando o código do professo.';
COMMENT ON COLUMN public.habilitacoes.dthabilitacao IS 'Parte da PK é a Data de habilitação do professor para ministrar a disciplina.';
...
CREATE TABLE public.historicoprofissional (
    ...
    fkfuncionario integer NOT NULL,
    fkempresa smallint DEFAULT NULL::numeric,
    fkatividade smallint NOT NULL,
...
COMMENT ON COLUMN public.historicoprofissional.fkempresa IS 'FK para tabela empresas.';
COMMENT ON COLUMN public.historicoprofissional.fkatividade IS 'FK para tabela atividades.';
...
COMMENT ON COLUMN public.instituicoesdeensino.fklogradouro IS 'FK com o código do logradouro da instituição de ensino.';
...
COMMENT ON COLUMN public.instituicoestels.fktipotelefone IS 'FK para a tabela tipos_telefones';
...
CREATE TABLE public.inventarios (
    ...
    fkproduto character(12) DEFAULT (0)::numeric NOT NULL,
    fkfuncionario integer DEFAULT (0)::numeric NOT NULL,
...
COMMENT ON COLUMN public.inventarios.fkfuncionario IS 'Parte da PK e FK apontando para a tabela Funcionários.';
COMMENT ON COLUMN public.inventarios.dtinventario IS 'Parte da PK é a Data de realização do inventário de estoque.';
...
COMMENT ON COLUMN public.livros.fkeditora IS 'FK com o código da editora que publicou o livro.';
...
CREATE TABLE public.logradouros (
    ...
    fkcidade integer,
    fklogradourotipo integer DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.logradouros.fkcidade IS 'FK para a tabela de Cidades.';
...
COMMENT ON COLUMN public.matriculas.fkfuncionario IS 'FK com o código do funcionario.';
...
CREATE TABLE public.medicos (
    ...
    fkespecialidade smallint NOT NULL,
    fkinstituicao smallint,
    fklogradouromoradia integer DEFAULT NULL::numeric,
    txcomplementomoradia character varying(50) DEFAULT NULL::character varying,
    nucepmoradia character(8),
    fklogradouroclinica integer DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.medicos.fkespecialidade IS 'FK com o código da especialidade médica';
COMMENT ON COLUMN public.medicos.fkinstituicao IS 'FK com o código da instituição de ensino onde o médico se formou.';
COMMENT ON COLUMN public.medicos.fklogradouromoradia IS 'FK com o código do Logradouro de moradia do Médico';
...
COMMENT ON COLUMN public.medicos.fklogradouroclinica IS 'FK com o código do Logradouro da Clínica Principal do Médico.';
...
CREATE TABLE public.movimentos (
    ...
    dtmovimento date,
    fktipomovimento smallint DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.movimentos.fkfuncionario IS 'FK para a tabela funcionarios (que faz o movimento).';
COMMENT ON COLUMN public.movimentos.dtmovimento IS 'Data de realização do movimento';
COMMENT ON COLUMN public.movimentos.fktipomovimento IS 'FK para a tabela movimentotipos.';
...
COMMENT ON COLUMN public.nfcompras.fkfuncionario IS 'FK com o código do funcionário.';
...
CREATE TABLE public.nfvendas (
    ...
    fkfuncionario integer DEFAULT NULL::numeric,
    fkarmazem smallint DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.nfvendas.fkfuncionario IS 'FK para a tabela funcionarios.';
COMMENT ON COLUMN public.nfvendas.fkarmazem IS 'FK para a tabela armazens.';
...
CREATE TABLE public.ocorrencias (
    ...
    fknumeroapolice integer NOT NULL,
    fklogradouroprincipal integer NOT NULL,
    fklogradourosecundario integer,
...
COMMENT ON COLUMN public.ocorrencias.fkveiculo IS 'FK indicando o código do veículo que sofreu o sinistro';
COMMENT ON COLUMN public.ocorrencias.fknumeroapolice IS 'FK para a tabela seguros (que cobre o sinistro do veículo).';
COMMENT ON COLUMN public.ocorrencias.fklogradouroprincipal IS 'FK com o código do Logradouro principal da ocorrência do sinistro.';
COMMENT ON COLUMN public.ocorrencias.fklogradourosecundario IS 'FK com o código do Logradouro secundário da ocorrência do sinistro';
...
COMMENT ON COLUMN public.oficinas.fklogradouro IS 'FK com o código do Logradouro da Oficina.';
...
COMMENT ON COLUMN public.oficinastels.fktipotelefone IS 'FK apontando para a tabela telefonestipos';
...
COMMENT ON COLUMN public.passagens.fkonibus IS 'FK com o código do ônibus para o qual se vende a passagem';
...
COMMENT ON COLUMN public.planosdesaude.fklogradouro IS 'FK com o código do logradouro do escritório do Plano de Saúde.';
...
COMMENT ON COLUMN public.planostels.fktipotelefone IS 'FK para a tabela tipos_telefones';
...
COMMENT ON COLUMN public.professores.fklogradouro IS 'FK com o código do Logradouro de residência do Professor.';
...
COMMENT ON COLUMN public.professorestels.fktipotelefone IS 'FK para a tabela tipos_telefones';
...
CREATE TABLE public.projetos (
    ...
    fkdepto character(3) DEFAULT NULL::bpchar,
    fkfuncionarioresponsavel smallint DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.projetos.fkdepto IS 'FK com o código do departamento que lidera ou coordena o projeto';
COMMENT ON COLUMN public.projetos.fkfuncionarioresponsavel IS 'FK com o código do funcionário responsável pelo projeto';
...
CREATE TABLE public.rotasviarias (
    ...
    fkcidadeorigem smallint DEFAULT NULL::numeric,
...
COMMENT ON COLUMN public.rotasviarias.fkcidadeorigem IS 'FK com o código da cidade de origem da rota viária';
...
COMMENT ON COLUMN public.roteiros.fkcidade IS 'FK apontando para a tabela cidades e parte da PK composta da Tabela.';
...
COMMENT ON COLUMN public.seguradoras.fklogradouro IS 'FK apontando o logradouro onde é a sede da seguradora.';
...
COMMENT ON COLUMN public.seguradorastels.fktipotelefone IS 'FK apontando para a tabela Tipos de Telefones.';
...
COMMENT ON COLUMN public.seguros.fkseguradora IS 'FK apontando para a tabela Seguradoras.';
...
COMMENT ON COLUMN public.servicosfeitospor.fkservico IS 'FK para tabela serviços (prestados por uma oficina).';
...
COMMENT ON COLUMN public.tarefasprojetos.fktarefa IS 'FK indicando o código da tarefa do projeto';
